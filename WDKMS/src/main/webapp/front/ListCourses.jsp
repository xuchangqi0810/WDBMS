        ...
        <div class="fl"> <span class="fs-12 line-h45 ftc-000000 dsblock fl"> 济南</span> <a href="城市.html" class="dsblock fl line-h45 fs-12 ftc-fc0503">[切换地图]</a> <a href="index.html" class="dsblock fl fs-12 ftc-000000 line-h45 m-l-70">首页</a> 
            ...
            <div class="hover-topnav fl m-l-45">
                <div class="dh_nav fl fs-12 ftc-000000 line-h45"><span class="dsblock hg-45"><i class="p-l-15 ql_icon top_wapewem hg-45 fl"></i>手机端</span>
                    <div class="top_wap_ewem bg-c-ffffff bd-sd-b"> <img src="${pageContext.request.contextPath}/front/images/pics/wap.png" width="100" alt=""/>
...
<div class="w-main m-auto m-t-37 m-b-25 ovhidden"> 
    <!--web logo start--> 
    <a href="index.html" class="logo fl"><img src="${pageContext.request.contextPath}/front/images/pics/ql_logo.gif" width="240" height="70" alt="齐峰教育logo(图)"/></a>
    <!--web logo end--> 
    <!--web search start-->
    ...
    <!--web search end-->
    <div class="fr"> <img src="${pageContext.request.contextPath}/front/images/pics/top_tel.gif" width="199" height="70" alt="齐峰教育400电话"/> </div>
</div>
    ...
    <div class="w-main m-auto"> 
        ...
        <div class="w-main m-auto m-t-25 fl">
            <ul class="home_calss w-1224 ovhidden">
                <c:forEach items="${detailsVideo}" var="item">
                    <li class="w-280 m-l-13 m-r-13 bg-c-ffffff m-t-8 m-b-33 fl"> <a href="${pageContext.request.contextPath}/getVideo/${item.t_vid}" class="dsblock w-280 hg-200 ovhidden ps-r"> <img src="pics/12.jpg" alt=""/> </a>
                        <div class="w-255 p-l-10 p-r-15 p-b-10 fl">
                            <div class="home_calsstxt w-155 fl">
                                <h3 class="w-all fs-16 ftc-000000 line-h32  one_hidden  m-t-6 fl">${item.t_vname}</h3>
                                </div>
...
<div class="w-all w-minw bg-c-f6f6f6 ovhidden">
    <div class="w-main m-auto"> 
        ...
        <ul class="ql_likeclass w-1210 ovhidden">
            <li class="w-230 bg-c-ffffff m-t-10 m-r-6 m-l-6 m-b-10 fl"> <a href="课程详情.html" class="dsblock w-230 hg-165 ovhidden ps-r"> <img src="${pageContext.request.contextPath}/front/images/pics/12.jpg" alt=""/> </a> <a href="课程详情.html" class="w-210 p-l-10 p-r-10 fl">
...
<div class="w-all w-minw bg-c-e3e3e3 p-t-15 ovhidden"> 
    ...
    <div class="w-main m-auto m-b-23 ovhidden">
        <div class="m-t-12 fl"> <a href="index.html" class="m-t-25 fl"><img src="${pageContext.request.contextPath}/front/images/pics/footer_logo.png" width="235" height="70" alt=""/></a>
        ...
        <div class="w-244 fr">
            <div class="w-112 m-l-10 fl"> <img src="${pageContext.request.contextPath}/front/images/pics/f_ewm1.gif" width="112" height="112" alt=""/>
